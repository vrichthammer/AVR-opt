...
public class AvrRelativeCreatorDecoderTest {

	private static AvrRelativeCreatorDecoder creator;
	...
	public static void setup() {
		...
		creator = new AvrRelativeCreatorDecoder(problem, random, searchSpaceSize);
	}
	...
	public void createTest() {
		...
		assertEquals(true, genotype.keySet().contains("RELATIVE"));
